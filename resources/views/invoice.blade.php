    ...
    <div class="container">
      <div class="logo">
        <a href="https://yammluck.com">
          <img
            src="C:\xampp\htdocs\Yamluck\front-end\static\pics\YAM LUCK-2-png.png"
            alt="Yammluck Logo"
          />
        </a>
      </div>
      ...
      <div class="card">
        <div style="text-align: center; line-height: 2em">
          <div style="font-weight: bold; font-size: 18px">Hi Ahmed!</div>
        ...
        <div class="order-information">
          ...
          <div class="row">
            <div class="col">
              ...
              <div>F2112181620121125</div>
            </div>
            <div class="col">
              <strong>Bill To:</strong>
              <div>eng.ahmedmohamed.2002@gmail.com</div>
            </div>
          </div>
          <div class="row">
            <div class="col">
      ...
      >
        Need Help?
        <a
          href="https://yammluck.com/help"
          style="color: #4545ef; text-decoration: none"
          >Yammluck.com/help</a
        >
      </strong>
      ...
      <div style="display: flex; justify-content: center; gap: 10px">
        <a
          href="https://yammluck.com/terms"
          style="font-size: 13px; color: #4545ef"
        >
          Terms of Service
        </a>
        <a
          href="https://yammluck.com/privacy"
          style="font-size: 13px; color: #4545ef"
        >
          Privacy Policy
        </a>
